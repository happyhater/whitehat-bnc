/*
 * Copyright (C) 2004-2018 WhiteHat, see the NOTICE file for details.
 *
...
class CWhiteHatMod : public CModule {
    public:
        MODCONSTRUCTOR(CWhiteHatMod) {
            AddHelpCommand();
...
GLOBALMODULEDEFS(CWhiteHatMod, "WhiteHat Assistance Module")
