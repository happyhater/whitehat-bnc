...
void CModules::GetDefaultMods(set<CModInfo>& ssMods,
    ...
    const map<CString, CModInfo::EModuleType> ns = {
        ...
        {"log", CModInfo::UserModule},
        {"block_motd", CModInfo::UserModule},
        {"buffextras", CModInfo::UserModule},
        {"clearbufferonmsg", CModInfo::UserModule},
        {"clientnotify", CModInfo::UserModule},
        {"disconkick", CModInfo::UserModule},
        {"simple_away", CModInfo::NetworkModule},
        {"autocycle", CModInfo::NetworkModule},
        {"autoop", CModInfo::NetworkModule},
        {"autovoice", CModInfo::NetworkModule},
        {"block_motd", CModInfo::NetworkModule},
        {"keepnick", CModInfo::NetworkModule},
        {"kickrejoin", CModInfo::NetworkModule},
        {"perform", CModInfo::NetworkModule},
        {"savebuff", CModInfo::NetworkModule},
        {"buffextras", CModInfo::NetworkModule},
        {"log", CModInfo::NetworkModule},
        {"log", CModInfo::GlobalModule},
        {"identfile", CModInfo::GlobalModule},
        {"lastseen", CModInfo::GlobalModule},
        {"fail2ban", CModInfo::GlobalModule},
        {"notify_connect", CModInfo::GlobalModule},
        {"webadmin", CModInfo::GlobalModule},
        {"whitehat", CModInfo::GlobalModule},
        {"lastseen", CModInfo::GlobalModule},
        {"perform", CModInfo::UserModule}};
